...
void print_ADC_value(char *, int,
                     int);   // Console print hex values from ADC, for debugging
...
void print_ADC_value(char *adc_response, int size,
                     int ch) // for debugging, print    hex values
{
  printf("ch%d: ", ch);
